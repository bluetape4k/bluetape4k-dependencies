...
| 계열 | 이전 | 적용 | 대표 검증 대상 |
| --- | --- | --- | --- |
| gRPC Java | `1.81.0` | `1.83.1` | `bluetape4k-projects` gRPC tests |
...
| MongoDB Java driver | `5.7.0` | `5.9.1` | projects/leader Mongo tests |
| Mutiny | `3.2.0` | `3.3.0` | `bluetape4k-projects` Mutiny tests |
