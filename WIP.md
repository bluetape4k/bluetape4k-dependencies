...
move managed upstream BOM refs to the next snapshot development lines:
...
- The next train is a snapshot validation line until each upstream repository
  publishes the matching snapshot artifact.
