...
- 2026-09-04 기준 Maven Central authoritative metadata 515개 line을
  ...
  128개를 갱신했습니다. Spring Boot 4.1.1, Jackson 2.22.2/3.2.2,
  ...
  Kotlin/Netty/Kafka compatibility line은 유지했습니다. Maven Central에
  POM이 없는 `managed-fastjson2-extension-spring6` 2.0.62는 별도 alias
  제거/migration train으로 보류했으며, 감사 delta와 publication/상호
  의존성 검증은 아직 `validation-pending`입니다.
