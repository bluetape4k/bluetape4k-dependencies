...
class LatestStableInventoryTest(unittest.TestCase):
    ...
    def test_cli_runs_with_the_active_python(self) -> None:
        ...
        self.assertIn("authority=519", result.stdout)
    ...
    def test_inventory_reconstructs_the_exact_authority_universe(self) -> None:
        ...
        self.assertEqual(inventory["summary"]["authority-count"], 519)
        ...
        self.assertEqual(inventory["summary"]["audit-pending"], 519)
        self.assertEqual(len(inventory["records"]), 519)
        self.assertEqual(
